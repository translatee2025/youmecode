      ...
      >
        ...
        <Tabs defaultValue="login" className="w-full">
          ...
          <TabsContent value="signup">
            <SignupForm isCreator={isCreatePlatform} />
          </TabsContent>
        </Tabs>
    ...
    <form onSubmit={handleLogin} className="space-y-4 pt-4">
      <div className="space-y-2">
        ...
        <Input
          ...
          className="bg-transparent border-[var(--color-border)] text-[var(--color-text)]"
        />
      </div>
      <div className="space-y-2">
      ...
      <button
        ...
        onClick={() => toast({ title: 'Check your email for reset instructions' })}
      >
        Forgot Password?
      </button>
    </form>
...
function SignupForm({ isCreator }: { isCreator: boolean }) {
  const tenant = useTenantStore((s) => s.tenant);
